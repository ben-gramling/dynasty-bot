...
## 10. Worked examples (2026-07-27 live values; v3.4: examples 1–2 re-pinned from fixtures at implementation — ΔW figures below are v3.3 face deltas until then; example 3 is ratio-based and unchanged)
...
10. Full nightly recompute within the v1 Lambda budget — the raw starter-sum solve enters the trade path (v3.4) via an incremental exact evaluator; the budgeted walks still saturate honestly.
