...
/**
 * One §5 v3.1 hedged pair — the board's PRIMARY unit: the buy side and its
 * hedge sell side as full embedded leg cards, listed in execution order
 * (sell first at the roster cap), with the combined ΔW, the posture-fit
 * summary, and the agreement-first sequencing note.
 */
      ...
      <header className="flex flex-wrap items-baseline gap-x-3 gap-y-1">
        ...
        <span className="ml-auto flex flex-wrap items-baseline gap-x-3 gap-y-1">
          ...
          <span
            ...
            title="Recommended pairs net Δ(roster count) ≤ 0 overall (§5)"
          >
            net roster{" "}
